...
namespace QuickGraph.Serialization.Mawingu
{
    ...
    internal static class SerializationHelper    
    {
        public static IEnumerable<PropertySerializationInfo> GetAttributeProperties(Type type,
            Dictionary<string, string> attrMappings)
        {
        ...
        public static bool TryGetAttributeName(PropertyInfo property, out string name)
        {
            ...
            {                
                ...
                {
                    //karl-otto
                    if (XmlReaderExtensions.attrmappings.ContainsKey(attribute.AttributeName))
                    {
                        name = XmlReaderExtensions.attrmappings[attribute.AttributeName];

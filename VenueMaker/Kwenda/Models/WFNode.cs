...
namespace WayfindR.Models
{
    ...
    public class WFNode
    {
		...
		public string Active
        {
            ...
            set
            {
                _active = value != null ? value.ToLower() : "";
            }
        } // Active
        ...
        public bool Equal(WFNode node)
        {
            if (Uuid != node.Uuid) return false;
            if (Major != node.Major) return false;
            if (Minor != node.Minor) return false;
